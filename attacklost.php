...
$expgainp=round($expgain/$ir['exp_needed']*100,4);
print " and lost $expgainp% EXP!";
mysql_query("UPDATE users SET exp=exp-$expgain WHERE userid=$userid",$c);
...
mysql_query("INSERT INTO attacklogs VALUES('',$userid,{$_GET['ID']},'lost',unix_timestamp(),0,'$atklog');",$c);
}
else
{
