...
<br>
Buying a house will give you more will which will help you train faster! <br />";
    if ($ir['maxwill'] > 100)
    {
        print "<a href='estate.php?sellhouse'><font color='darkblue'>Click here to Sell Your House</font></a><br />";
    }
    $hq =
            mysql_query(
