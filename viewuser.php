...
<img src='anime-blue paper.png'>Location: {$r['cityname']}</td><td>
<img src='anime-green letter s.png'>Money: \${$r['money']}<br />
<img src='anime-ap.png'>AP: {$r['crystals']}<br />
Property: {$r['hNAME']}<br />
Referals: ";
        $rr =
                mysql_query(
...
<th>Physical Info</th><th>Links</th>{$sh}</tr>";
if ($r['level']!=999){
print"<tr><td>Level: {$r['level']}<br />";}
elseif ($r['level']==999){
print"<tr><td>Level: <font color='darkred'><b>MAX</b></font><br />";}
print"
<img src='anime-hp heart.png'>Health: {$r['hp']}/{$r['maxhp']}<br />";
if ($r['race'] == 'Demi-God')
{
print"
<img src='anime-list.png'>Race: <font color='blue'><b>Demi-God</font></b><br />";
}
else
{
print"
<img src='anime-list.png'>Race: {$r['race']}<br />";
}
print"
<img src='anime-crown.png'>Class: ";
if ($r['rank'] == 'Pirate')
{ 
print" <font color ='red'><b>
{$r['rank']}</b><br /></font>";
}
elseif ($r['rank'] == 'Duelist')
{ 
print"<font color ='purple'><b> 
 {$r['rank']}</b><br /></font>";
}
else
 { print"
...
<input type='submit' value='Change' /></form>";
        ...
        print 
                "</td><td>[<a href='dnabook.php?u={$r['userid']}'>Check DNA</a>]<br /><br />
                [<a href='mailbox.php?action=compose&ID={$r['userid']}'>Send Mail</a>]<br /><br />
