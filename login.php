...
print
    ...
    <table width="80%">
      <tr>
        <td width="50%">
          <fieldset>
            <legend>About Battlerpg</legend>
            Battlerpg (name under construction) is an online social text-based game that has references from pop culture. We are currently in the Pre-Alpha stage! Enjoy your stay!
            <br>
            <a href='/lol/login.php'>LOL Manager</a>
          </fieldset>
        </td>
        <td>
          <fieldset>
